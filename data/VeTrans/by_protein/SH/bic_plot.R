...
# Read the CSV file
bic <- read.csv("/Users/e.smith.5/Documents/PhD/RSV_project/RSV_haplotype_reconstruction/data/VeTrans/by_protein/SH/extracted_bic.csv")
...
bic_plot <- ggplot(bic, aes(x = n_haps, y = BIC)) +
  geom_point() +
  labs(title="SH", x="# Haplotypes", y="BIC") +
  theme_minimal()

# Save the plot
ggsave("/Users/e.smith.5/Documents/PhD/RSV_project/RSV_haplotype_reconstruction/data/VeTrans/by_protein/SH/bic_plot.jpeg", plot = bic_plot, width = 8, height = 6)
