...
# Read the CSV file
bic <- read.csv("/Users/e.smith.5/Documents/PhD/RSV_project/RSV_haplotype_reconstruction/data/VeTrans/by_protein/NS2/extracted_bic.csv")
...
bic_plot <- ggplot(bic, aes(x = n_haps, y = BIC)) +
  geom_point() +
  labs(title="NS2", x="# Haplotypes", y="BIC") +
  theme_minimal()

# Save the plot
ggsave("/Users/e.smith.5/Documents/PhD/RSV_project/RSV_haplotype_reconstruction/data/VeTrans/by_protein/NS2/bic_plot.jpeg", plot = bic_plot, width = 8, height = 6)
